...
enum BeatLibrary {
    ...
    static let threeAct: [BeatTemplate] = [
        BeatTemplate(
            key: "openingImage", act: 1, actLabel: "Act I",
            title: "Opening Image",
            ...
            startPct: 0, endPct: 1),
        BeatTemplate(
            key: "themeStated", act: 1, actLabel: "Act I",
            title: "Theme Stated",
            ...
            startPct: 5, endPct: 6),
        BeatTemplate(
            key: "setup", act: 1, actLabel: "Act I",
            title: "Setup",
        ...
        BeatTemplate(
            key: "catalyst", act: 1, actLabel: "Act I",
        ...
        BeatTemplate(
            key: "debate", act: 1, actLabel: "Act I",
            title: "Debate",
        ...
        BeatTemplate(
            key: "breakIntoTwo", act: 2, actLabel: "Act II",
        ...
        BeatTemplate(
            key: "bStory", act: 2, actLabel: "Act II",
            title: "B Story",
        ...
        BeatTemplate(
            key: "funAndGames", act: 2, actLabel: "Act II",
            title: "Fun and Games",
        ...
        BeatTemplate(
            key: "midpoint", act: 2, actLabel: "Act II",
            title: "Midpoint",
        ...
        BeatTemplate(
            key: "badGuysCloseIn", act: 2, actLabel: "Act II",
        ...
        BeatTemplate(
            key: "allIsLost", act: 2, actLabel: "Act II",
            title: "All Is Lost",
        ...
        BeatTemplate(
            key: "darkNight", act: 2, actLabel: "Act II",
        ...
        BeatTemplate(
            key: "breakIntoThree", act: 3, actLabel: "Act III",
        ...
        BeatTemplate(
            key: "finale", act: 3, actLabel: "Act III",
            title: "Finale",
        ...
        BeatTemplate(
            key: "finalImage", act: 3, actLabel: "Act III",
            title: "Final Image",
    ...
    static func fiveAct(medium: Medium) -> [BeatTemplate] {
        ...
        if medium == .tv {
            beats.append(BeatTemplate(
                key: "teaser", act: 0, actLabel: "Teaser",
                title: "Teaser",
        ...
        beats.append(contentsOf: [
            BeatTemplate(
                key: "exposition", act: 1, actLabel: "Act I",
            ...
            BeatTemplate(
                key: "risingAction", act: 2, actLabel: "Act II",
            ...
            BeatTemplate(
                key: "climaxTurn", act: 3, actLabel: "Act III",
            ...
            BeatTemplate(
                key: "fallingAction", act: 4, actLabel: "Act IV",
            ...
            BeatTemplate(
                key: "resolution", act: 5, actLabel: "Act V",
